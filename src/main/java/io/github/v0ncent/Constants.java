...
public class Constants {
    /**
     * Constants pertaining to the actual JFrame window itself.
     */
    ...
    /**
     * Constants pertaining to the ProjectGenerator component.
    ...
    /**
     * All the JDate engines status codes.
     */
    public static final class StatusCodes {
        public static final class GameJsonValidationCodes {
            public static final String GAME_JSON_OK = "Game Json: Ok";
            public static final String GAME_JSON_BAD_SCRIPT = "Game Json: Bad Script";
            public static final String GAME_JSON_BAD_NAME = "Game Json: Bad name";
        }

        public static final class FileValidationCodes {
            public static final String FILE_VALIDATION_OK = "File Validation: Ok";
            public static final String FILE_VALIDATION_FAILED = "File Validation: Failed";
        }
    }

    /**
     * Constants pertaining to file content generated by application.
     */
    public static final class FileContent {
        ...
        public static final String COMPILED_FUNCTIONS_CLASS_DIRECTORY = "CompiledFunctions";
        public static final String JDATE_SCRIPT_EXTENSION = ".jdate";
    }

    /**
     * Constants pertaining to general application info.
     */
    public static final class ApplicationInfo {
        public static final String STARTUP_LOGO = " @@@@@@@@@@@@@@@@@@@          @@@@@@@@@@@@@@@@@                                @@@@@@@@@@          @@@@@@@@@@@@@@@@@@@@@@@@@@@@               @@@@@@@@         \n" +
                "  @@@@@@@@@@@@@@@@@@@@@@@      @@@@@@@@@@@@@@@@@@@@@@                    @@@@@@@@@@@@@@@@@@         @@@@@@@@@@@@@@@@@@@@@@@@@@@@           @@@@@@@@@@@@@@@@     \n" +
                "  @@@@@@@@@@@@@@@@@@@@@@@      @@@@@@@@@@@@@@@@@@@@@@@@                  @@@@@@@@@@@@@@@@@@@        @@@@@@@@@@@@@@@@@@@@@@@@@@@@        @@@@@@@@@@@@@@@@@@@@@   \n" +
                "  @@@@@@@@@@@@@@@@@@@@@@@      @@@@@@@@@@@@@@@@@@@@@@@@@@               @@@@@@@@@@@@@@@@@@@@        @@@@@@@@@@@@@@@@@@@@@@@@@@@@       @@@@@@@@@@@@@@@@@@@@@@@  \n" +
                "  @@@@@@@@@@@@@@@@@@@@@@@@     @@@@@@@@@@@@@@@@@@@@@@@@@@@@             @@@@@@@@@@@@@@@@@@@@@       @@@ @@@@@@@@@@@  @@@@@@@@@@      @@@@@@@@@@@@@@@@@@@@@@@@@@ \n" +
